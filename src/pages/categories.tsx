    ...
    <div className='pb-44'>
      ...
      {categorySpending.length > 0 && (
        <div className='mt-4 mb-6'>
          <PTypography variant='body-wide' className='text-neutral-400 uppercase mb-2'>
            This month
          </PTypography>
          <div className='flex gap-3 overflow-x-auto pb-2 no-scrollbar -mx-4 px-4'>
            {categorySpending.map((item) => (
              ...
              >
                <AppTypography variant='small' className='text-neutral-500 truncate block mb-1'>
                  {item.categoryName}
                </AppTypography>
      ...
      {/* Category list */}
      {isLoading && (
        <AppTypography variant='small' className='text-neutral-400 text-center py-8'>
          Loading...
        </AppTypography>
      )}
